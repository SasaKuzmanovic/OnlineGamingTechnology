...
public: //Public functions
	...
	bool Connect();
	std::string returnPlayerPos()
	{
		return positionMessage;
	}
	bool SendString(std::string & _string);
	bool SendPlayerPosition(std::string& _string);
	bool ReturnPlayerPosition(std::string& _string);
	bool GetPlayerPosition(std::string& _string);
	bool CloseConnection();
	bool GetNumberOfClients(int& _int);
private: //Private functions
	...
	std::string getPlayerPosMessage();
	
	bool GetPlayerID(int& _int);
